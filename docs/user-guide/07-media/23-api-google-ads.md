# Connexion API Google Ads

> **Section**: Media > Connexions API > Google Ads
> **URL**: `/admin/media/api-google-ads`
...
La page **API Google Ads** permet de configurer la connexion technique entre Koraline et Google Ads. Une fois configuree, cette connexion permet a Koraline d'interagir avec Google Ads pour : Gestion des campagnes publicitaires Google.
...
2. Cliquez sur la carte **Google Ads** dans la section integrations
3. Ou naviguez vers `/admin/media/api-google-ads`
...
| **Identifiants requis** | Developer Token, Client ID, Client Secret, Customer ID |
| **Documentation officielle** | [https://developers.google.com/google-ads/api/](https://developers.google.com/google-ads/api/) |

---

## Comment connecter Google Ads

### Etape 1 : Obtenir les identifiants
Demandez un Developer Token dans votre compte Google Ads (Manager). Le Customer ID est le numero a 10 chiffres de votre compte.

### Etape 2 : Configurer dans Koraline
1. Sur la page API Google Ads, activez l'interrupteur **Activer**
...
### Note technique
Le Developer Token peut prendre plusieurs jours a obtenir. Commencez avec un token de test.
...
R : Les donnees existantes sont conservees, mais Koraline ne communiquera plus avec Google Ads. Vous pouvez reactiver a tout moment.
