# Connexion API Meta (Facebook/Instagram)

> **Section**: Media > Connexions API > Meta (Facebook/Instagram)
> **URL**: `/admin/media/api-meta`
...
La page **API Meta (Facebook/Instagram)** permet de configurer la connexion technique entre Koraline et Meta (Facebook/Instagram). Une fois configuree, cette connexion permet a Koraline d'interagir avec Meta (Facebook/Instagram) pour : Publication Facebook/Instagram et publicites.
...
2. Cliquez sur la carte **Meta (Facebook/Instagram)** dans la section integrations
3. Ou naviguez vers `/admin/media/api-meta`
...
| Champ | Description |
|-------|-------------|
| **Fournisseur** | Meta for Developers |
| **Identifiants requis** | App ID, App Secret, Access Token |
| **Documentation officielle** | [https://developers.facebook.com/docs/](https://developers.facebook.com/docs/) |

---

## Comment connecter Meta (Facebook/Instagram)

### Etape 1 : Obtenir les identifiants
Creez une application sur developers.facebook.com. Associez votre page Facebook et votre compte Instagram Business.

### Etape 2 : Configurer dans Koraline
1. Sur la page API Meta (Facebook/Instagram), activez l'interrupteur **Activer**
...
### Note technique
L'Access Token Meta expire regulierement. Configurez le renouvellement automatique via OAuth.
...
R : Les donnees existantes sont conservees, mais Koraline ne communiquera plus avec Meta (Facebook/Instagram). Vous pouvez reactiver a tout moment.
