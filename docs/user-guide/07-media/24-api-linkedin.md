# Connexion API LinkedIn

> **Section**: Media > Connexions API > LinkedIn
> **URL**: `/admin/media/api-linkedin`
...
La page **API LinkedIn** permet de configurer la connexion technique entre Koraline et LinkedIn. Une fois configuree, cette connexion permet a Koraline d'interagir avec LinkedIn pour : Publication et publicites LinkedIn.
...
2. Cliquez sur la carte **LinkedIn** dans la section integrations
3. Ou naviguez vers `/admin/media/api-linkedin`
...
| Champ | Description |
|-------|-------------|
| **Fournisseur** | LinkedIn Developer |
| **Identifiants requis** | Client ID, Client Secret |
| **Documentation officielle** | [https://docs.microsoft.com/en-us/linkedin/](https://docs.microsoft.com/en-us/linkedin/) |
...
Creez une application sur linkedin.com/developers. Demandez les produits 'Share on LinkedIn' et 'Marketing APIs'.

### Etape 2 : Configurer dans Koraline
1. Sur la page API LinkedIn, activez l'interrupteur **Activer**
...
### Note technique
Les Marketing APIs de LinkedIn necessitent une approbation speciale. Le processus peut prendre 1 a 2 semaines.
...
R : Les donnees existantes sont conservees, mais Koraline ne communiquera plus avec LinkedIn. Vous pouvez reactiver a tout moment.
