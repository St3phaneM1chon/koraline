...
function getDefaultGreeting(language: string): string {
  const greetings: Record<string, string> = {
    en: "👋 Hello! Welcome to Attitudes VIP. I'm here to help you with any questions about our research peptides. How can I assist you today?",
    fr: "👋 Bonjour! Bienvenue chez Attitudes VIP. Je suis là pour répondre à vos questions sur nos peptides de recherche. Comment puis-je vous aider?",
    es: "👋 ¡Hola! Bienvenido a Attitudes VIP. Estoy aquí para ayudarte con cualquier pregunta sobre nuestros péptidos de investigación. ¿Cómo puedo ayudarte hoy?",
    de: "👋 Hallo! Willkommen bei Attitudes VIP. Ich bin hier, um Ihnen bei Fragen zu unseren Forschungspeptiden zu helfen. Wie kann ich Ihnen heute helfen?",
    it: "👋 Ciao! Benvenuto in Attitudes VIP. Sono qui per aiutarti con qualsiasi domanda sui nostri peptidi di ricerca. Come posso aiutarti oggi?",
    pt: "👋 Olá! Bem-vindo à Attitudes VIP. Estou aqui para ajudá-lo com qualquer pergunta sobre nossos peptídeos de pesquisa. Como posso ajudá-lo hoje?",
    zh: "👋 你好！欢迎来到Attitudes VIP。我在这里帮助您解答关于我们研究肽的任何问题。今天我能为您做什么？",
    ar: "👋 مرحباً! أهلاً بك في Attitudes VIP. أنا هنا لمساعدتك في أي أسئلة حول ببتيدات البحث لدينا. كيف يمكنني مساعدتك اليوم؟",
    ru: "👋 Привет! Добро пожаловать в Attitudes VIP. Я здесь, чтобы помочь вам с любыми вопросами о наших исследовательских пептидах. Чем могу помочь?",
    // F-060 FIX: Add greetings for the 13 missing supported languages
    ko: "👋 안녕하세요! Attitudes VIP에 오신 것을 환영합니다. 연구용 펩타이드에 대한 질문이 있으시면 도와드리겠습니다.",
    pl: "👋 Cześć! Witamy w Attitudes VIP. Jestem tu, aby pomóc Ci z pytaniami dotyczącymi naszych peptydów badawczych.",
    sv: "👋 Hej! Välkommen till Attitudes VIP. Jag finns här för att hjälpa dig med frågor om våra forskningspeptider.",
    hi: "👋 नमस्ते! Attitudes VIP में आपका स्वागत है। हमारे अनुसंधान पेप्टाइड्स के बारे में किसी भी प्रश्न में मदद के लिए मैं यहाँ हूँ।",
    vi: "👋 Xin chào! Chào mừng đến với Attitudes VIP. Tôi ở đây để giúp bạn với các câu hỏi về peptide nghiên cứu của chúng tôi.",
    tl: "👋 Kumusta! Maligayang pagdating sa Attitudes VIP. Nandito ako para tulungan ka sa mga tanong tungkol sa aming mga research peptide.",
    ta: "👋 வணக்கம்! Attitudes VIP-க்கு வரவேற்கிறோம். எங்கள் ஆராய்ச்சி பெப்டைடுகள் பற்றிய கேள்விகளுக்கு உதவ நான் இங்கே இருக்கிறேன்.",
    pa: "👋 ਸਤ ਸ੍ਰੀ ਅਕਾਲ! Attitudes VIP ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗਤ ਹੈ। ਸਾਡੇ ਖੋਜ ਪੈਪਟਾਈਡਜ਼ ਬਾਰੇ ਸਵਾਲਾਂ ਵਿੱਚ ਮਦਦ ਲਈ ਮੈਂ ਇੱਥੇ ਹਾਂ।",
    ht: "👋 Bonjou! Byenvini nan Attitudes VIP. Mwen la pou ede w ak nenpòt kesyon sou peptid rechèch nou yo.",
    gcr: "👋 Bonjou! Byenvini dan Attitudes VIP. Mo la pou édé ou ké nenpòt kestion asou peptid recherche nou.",
  };
