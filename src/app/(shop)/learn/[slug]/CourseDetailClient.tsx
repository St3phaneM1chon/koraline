              ...
              {enrollmentState ? (
                ...
                <div>
                  <button
                    ...
                    disabled={enrolling}
                    className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors"
                  >
                    {enrolling ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-gray-500">{chapter.lessons.length} {chapter.lessons.length === 1 ? 'lesson' : 'lessons'}</span>
                        </div>
                      </div>
                      <svg
                        className={`w-5 h-5 text-gray-400 transition-transform ${expandedChapters.has(chapter.id) ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                            ...
                            <div key={lesson.id} className="flex items-center gap-3 px-4 py-3 ps-14">
                              ...
                              {enrollmentState ? (
                                <Link
                                  ...
                                  className="text-sm text-gray-700 hover:text-blue-600 flex-1"
                                >
                                  {lesson.title}
                                </Link>
                              ) : (
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-xl p-6 border border-gray-200 sticky top-24 space-y-6">
              <h3 className="font-semibold text-gray-900">{t('lms.courseDetail.includes')}</h3>
              ...
              {course.instructor && (
                <div className="border-t border-gray-200 pt-4">
                  <h4 className="text-sm font-medium text-gray-500 mb-2">{t('lms.courseDetail.instructor')}</h4>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">{course.instructor.title}</p>
              ...
              {course.prerequisites.length > 0 && (
                <div className="border-t border-gray-200 pt-4">
                  <h4 className="text-sm font-medium text-gray-500 mb-2">{t('lms.courseDetail.prerequisites')}</h4>
                  <ul className="space-y-1">
                    {course.prerequisites.map((prereq) => (
                      <li key={prereq.id}>
                        <Link href={`/learn/${prereq.slug}`} className="text-sm text-blue-600 hover:underline">
                          {prereq.title}
                        </Link>
                      </li>
                    ))}
