        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '14px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.8 }}>
              ...
              <p>
                <a href={`mailto:${process.env.NEXT_PUBLIC_EMAIL || 'info@attitudes.vip'}`} style={{ color: 'inherit' }}>
                  ✉️ {process.env.NEXT_PUBLIC_EMAIL || 'info@attitudes.vip'}
                </a>
              </p>
            </div>
          </div>
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Image src="/images/suite-koraline.png" alt="Suite Koraline" width={80} height={24} style={{ height: '24px', width: 'auto' }} />
